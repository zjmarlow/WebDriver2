...
# - browse to new page asynchronously
# - access data from new page - verify it's different

my IO::Path $html-file =
		.add: 'page-nav-async.html' with $*PROGRAM.parent.parent.add: 'content';
...
class Frames-Test does WebDriver2::Test::PO-Test {
	...
	method test {
		$!from.nav;
		self.is: 'from text', 'async from page', $!from.page-link-text;
		self.ok: 'async page navigation detected', $!from.page-link;
